...
export class RolesGuard extends AuthGuard(AUTH_CONSTANT.COMMON.JWT) implements CanActivate {
  ...
  async canActivate(context: ExecutionContext) {
    ...
    const requiredRoles = this.reflector.getAllAndOverride<Role[]>(AUTH_CONSTANT.UTIL.ROLES, [
      context.getHandler(),
      context.getClass(),
    ]);
    if (!requiredRoles) {
